"""
Classification metrics — compute_classification_metrics and private helpers.

Internal dependencies (within this package):
  - binary.py  : _is_zero_one_label_set, get_class_labels
  - curves.py  : compute_roc_pr_curves, compute_calibration_curve
"""
...
def compute_classification_metrics(
    ...
    *,
    ...
    try:
        ...
        cm_matrix = _confusion_matrix(y_true_arr, y_pred_arr, labels=np.asarray(resolved_labels)).astype(int).tolist()
    except Exception as exc:
...
def classification_metrics(
    ...
    *,
    ...
    """Thin wrapper kept for backward-compat with evaluator.py and orchestrator._run_loo."""
